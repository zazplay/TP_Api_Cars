...
var PaginationControl = function PaginationControl(_ref) {
  ...
  return total !== null && total > 0 ? React.createElement(reactBootstrap.Pagination, {
    className: "justify-content-md-center"
  }, last && React.createElement(reactBootstrap.Pagination.First, {
    onClick: function onClick() {
      return page > 1 ? changePage(1) : {};
    },
    disabled: page <= 1
  }), next && React.createElement(reactBootstrap.Pagination.Prev, {
    onClick: function onClick() {
  ...
  total_pages > between * 2 + 1 && ellipsis > 0 && page - 1 > between && React.createElement(reactBootstrap.Pagination.Ellipsis, {
    disabled: true
  ...
  total_pages > between * 2 + 1 && ellipsis > 0 && page < total_pages - between && React.createElement(reactBootstrap.Pagination.Ellipsis, {
    disabled: true
  ...
  }), next && React.createElement(reactBootstrap.Pagination.Next, {
    onClick: function onClick() {
      return page < total_pages ? changePage(page + 1) : {};
    },
    disabled: page >= total_pages
  }), last && React.createElement(reactBootstrap.Pagination.Last, {
    onClick: function onClick() {
...
//# sourceMappingURL=react-bootstrap-pagination-control.cjs.development.js.map
